...
public final class App {
  ...
  private static String IGPU = "https://www.amazon.com/MSI-GeForce-RTX-2060-Architecture/dp/B07MQ36Z6L/ref=sr_1_10?keywords=rtx+2060&qid=1575999305&s=electronics&sr=1-10";
  ...
  private static String ICASE = "https://www.amazon.com/gp/product/B01N9JPUYW/ref=ox_sc_act_title_3?smid=ATVPDKIKX0DER&th=1";
  ...
  private static String ACASE = "https://www.amazon.com/gp/product/B01N9JPUYW/ref=ox_sc_act_title_3?smid=ATVPDKIKX0DER&th=1";
  ...
  public static void main(String[] args) throws IOException {
    ...
    Javalin app = Javalin.create(config -> {
     ...
     for (int i = 0; i < BParts.length; i++) {
      document1 = Jsoup.connect(BParts[i]).userAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36")
          .timeout(0).get();
